...
const mockedUpdateResearchSettings = vi.mocked(updateResearchSettings);
...
describe("App", () => {
  beforeEach(() => {
    ...
    mockedListTags.mockResolvedValue({ items: [] });
    ...
    mockedUpdateResearchSettings.mockResolvedValue({
      ...defaultSettings,
  ...
  it("returns to login when merged tag loading reports authentication_required", async () => {
    mockedListSources.mockResolvedValue({ items: [importedSource], total: 1, page: 1, page_size: 20 });
    mockedGetSource.mockResolvedValue({ source: importedSource, artifacts: [] });
    mockedListTags.mockRejectedValue({
      code: "authentication_required",
      message: "Authentication is required.",
      status: 401,
    });
  ...
  it("returns to login when merged research settings mutation reports authentication_required", async () => {
    mockedListSources.mockResolvedValue({ items: [importedSource], total: 1, page: 1, page_size: 20 });
    mockedGetSource.mockResolvedValue({ source: importedSource, artifacts: [] });
    mockedUpdateResearchSettings.mockRejectedValue({
      code: "authentication_required",
      message: "Authentication is required.",
      status: 401,
    });
